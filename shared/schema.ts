...
const baseInsertProductSchema = createInsertSchema(products).omit({ id: true }).extend({
  ...
  shippoWeight: z.coerce.number().positive().optional().nullable().transform(val => val ? String(val) : undefined),
  shippoLength: z.coerce.number().positive().optional().nullable().transform(val => val ? String(val) : undefined),
  shippoWidth: z.coerce.number().positive().optional().nullable().transform(val => val ? String(val) : undefined),
  shippoHeight: z.coerce.number().positive().optional().nullable().transform(val => val ? String(val) : undefined),
