...
export function OwnerStorefrontHeader({ cartItemsCount = 0, onCartClick }: OwnerStorefrontHeaderProps) {
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between gap-4 px-4 mx-auto max-w-7xl">
              ...
              <div className="flex flex-col gap-6 mt-6">
                ...
                <nav className="flex flex-col gap-2">
                  ...
                  <Link
                    ...
                    onClick={() => setMobileMenuOpen(false)}
                    className="text-base font-medium hover-elevate px-3 py-2.5 rounded-lg"
                    data-testid="mobile-link-meta-ads"
                  >
                    Meta Ads
                  </Link>
                  <Link
        ...
        <div className="flex items-center gap-2">
          ...
          {/* No cart for owners viewing their own store */}
