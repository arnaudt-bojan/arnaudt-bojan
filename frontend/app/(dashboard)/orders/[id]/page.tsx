    ...
    <DashboardLayout title={`Order ${order.orderNumber}`}>
      <Container maxWidth="xl" sx={{ py: 4 }}>
            ...
            <Card sx={{ mb: 3 }}>
              <CardContent>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'flex-end' }}>
                  <Box sx={{ display: 'flex', gap: 2, justifyContent: 'space-between', minWidth: 200 }}>
                    <Typography variant="body2">Subtotal:</Typography>
                    <Typography variant="body2" fontWeight="600" data-testid="text-subtotal">
                      ${order.subtotal.toFixed(2)}
                    </Typography>
                  </Box>
                  <Box sx={{ display: 'flex', gap: 2, justifyContent: 'space-between', minWidth: 200 }}>
                    <Typography variant="body2">Shipping:</Typography>
                    <Typography variant="body2" fontWeight="600" data-testid="text-shipping">
                      ${order.shippingCost.toFixed(2)}
                    </Typography>
                  </Box>
                  <Box sx={{ display: 'flex', gap: 2, justifyContent: 'space-between', minWidth: 200 }}>
                    <Typography variant="body2">Tax:</Typography>
                    <Typography variant="body2" fontWeight="600" data-testid="text-tax">
            ...
            <Card sx={{ mb: 3 }}>
              <CardContent>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  ...
                  <Box>
                    <Typography variant="caption" color="text.secondary">Fulfillment Status</Typography>
                    <Box sx={{ mt: 0.5 }}>
                      <Chip
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  <Box>
                    ...
                    <Typography variant="body2" data-testid="text-customer-name">
                      {order.customerName || order.buyer?.fullName || 'N/A'}
                    </Typography>
                  </Box>
                  <Box>
            ...
            {order.shippingAddress && (
              <Card sx={{ mb: 3 }}>
                <CardContent>
                  ...
                  <Divider sx={{ mb: 2 }} />
                  <Typography variant="body2" data-testid="text-shipping-address">
                ...
                <CardContent>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                    <Box>
                      ...
                      <Typography variant="body2" data-testid="text-carrier">
                        {order.carrier || 'N/A'}
                      </Typography>
                    </Box>
                    <Box>
                      <Typography variant="caption" color="text.secondary">Tracking Number</Typography>
                      <Typography variant="body2" fontFamily="monospace" data-testid="text-tracking-number">
                        {order.trackingNumber}
                      </Typography>
                    </Box>
                  </Box>
        ...
        <Dialog open={trackingDialogOpen} onClose={() => setTrackingDialogOpen(false)} maxWidth="sm" fullWidth>
          ...
          <DialogActions>
            <Button onClick={() => setTrackingDialogOpen(false)} data-testid="button-cancel-tracking">
              Cancel
            </Button>
            <Button
              onClick={handleAddTracking}
              variant="contained"
              disabled={!carrier || !trackingNumber || updateLoading}
        ...
        <Dialog open={statusDialogOpen} onClose={() => setStatusDialogOpen(false)} maxWidth="sm" fullWidth>
          ...
          <DialogActions>
            <Button onClick={() => setStatusDialogOpen(false)} data-testid="button-cancel-status">
              Cancel
            </Button>
            <Button
